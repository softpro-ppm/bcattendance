-- STEP 1: Drop existing database and create fresh one
...
-- STEP 3: Create Constituencies table
...
-- STEP 6: Create Beneficiaries table
...
SELECT 'Admin user created' as 'Admin Status';
